...
[assembly: Dependency(typeof(BigSlickChat.iOS.OneSignalServiceIos))]
namespace BigSlickChat.iOS
{
	public class OneSignalServiceIos : OneSignalService
	{

		//public void Init(string oneSignalAppId, string googleProjectNumber)
		//{
		//	OneSignal.NotificationOpened exampleNotificationReceivedDelegate = delegate (OSNotification notification)
		//	{
		//		try
		//		{
